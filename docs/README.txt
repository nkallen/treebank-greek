This is a README file for the Ancient Greek Dependency Treebank, version 1.6.
...
1. Preamble
	...
	1.2 License
		...
		AGDT 1.6 is licensed under a Creative Commons Attribution- 
...
2. Documentation
	...
	2.2 Text
		...
		AGDT 1.6 is comprised of 14 texts, in the following distribution:
	...
	2.4 Authorship
		...
		Aside from the scholarly treebanks of Aeschylus (ed., Francesco Mambrini),
                Plato (ed., Giuseppe G.A. Celano) and Sophocles (ed., Dan Libatique), 
                each sentence in the Ancient Greek Dependency Treebank is built from the 
                efforts of two independent annotators (marked "primary" in the data) reconciled 
                by a third (marked "secondary").  We would like to recognize the contribution 
